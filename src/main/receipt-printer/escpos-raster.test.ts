...
describe('encodeRasterBand', () => {
  it('packs black pixels from the most-significant bit and pads the row white', () => {
    const bitmap = Buffer.from([
      ...pixel(0), ...pixel(255), ...pixel(255), ...pixel(255),
      ...pixel(255), ...pixel(255), ...pixel(255), ...pixel(0),
      ...pixel(255), ...pixel(0), ...pixel(255), ...pixel(255),
      ...pixel(255), ...pixel(255), ...pixel(255), ...pixel(255),
    ]);
